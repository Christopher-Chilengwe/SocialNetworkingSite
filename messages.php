		...
		<div class="art-post-inner art-article">
			...
			<div class="art-block-body">
						<div class="art-blockheader">
							<div class="l"></div>
							<div class="r"></div>
							<h3 class="t">Send Mails to your school friends</h3>
						</div>
						<div class="art-blockcontent">
						...
						<div class="cleared"></div>
							...
							<?php
								...
								$row = mysql_fetch_array($post); 
								?>
							&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="from" id="inputtype" value="<?php  echo $row['member_id']; echo $row['firstname']; ?>">
							...
							<?php 
								...
								$member_id=$_SESSION['member_id'];								
									...
									echo '<option value = '.$friendsa['member_id'].'>'.$friendsa['member_id'].' '.$friendsa['lastname'].'</option>';
