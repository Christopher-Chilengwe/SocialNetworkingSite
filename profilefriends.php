						...
						<div class="cleared"></div>
							<div>
								<form method="post" action="">
									...
									<p>&nbsp;&nbsp;Course: <strong>&nbsp; <?php echo $row['course'];?> </strong>&nbsp;&nbsp;&nbsp;&nbsp;</p>
									<p>&nbsp;&nbsp;Birthdate: <strong>&nbsp; <?php echo $row['birthdate'];?> </strong> &nbsp;&nbsp;</p>
									<br>
									<br>
									<br>
									<br>
									<p>&nbsp;&nbsp;Do you want <?php echo $row['firstname'];?> to be your school friend?</p>
									<?php
									$id = $row['member_id'];
									?>
									<p>&nbsp;&nbsp;<a href="addfriend.php?id=<?php $row['member_id']; ?>" rel="facebox" style="text-decoration:none;">Add as School Friend</a></p>
								</form>
