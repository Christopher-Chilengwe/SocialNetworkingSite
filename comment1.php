			...
			<div class="art-block-body">
						...
						<div>
							...
							<div>
								...
								<?php 
									...
									while($row = mysql_fetch_array($post)){
										...
										echo "<div>
											...
											".$row['comment']."<br /><br /><strong>Last</strong> ".$row['date']."<hr /> <a href='seeall.php?id=".$row['postcommentid']."' rel='facebox'>Like</a><a href='seeall.php?id=".$row['postcommentid']."' rel='facebox'> see all()</a>
											<div style='float:right;'><a href='deletepostcommenthome.php?post_id=".$row['postcommentid']."'>Delete</a></div>
											<hr />
								...
								?>
								<form method='post' action='hometest.php'>
									...
									<input style='width:150px; height:50px; float:right;' type='submit' name='comment' value='comment'/>
								</form>
							</div>
