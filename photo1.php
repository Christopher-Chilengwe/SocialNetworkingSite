		...
		<div class="art-post-inner art-article" style="margin-top: 20px;">
			...
			<div class="art-block-body" style="width: 495px;">
						<div class="art-blockheader">
							<div class="l"></div>
							<div class="r"></div>
							<h3 class="t">Photos of <?php echo $row['firstname'];?></h3>
						</div>
						<div class="art-blockcontent">
							<div class="art-blockcontent-body">
						...
						<div class="cleared"></div>
							<div>
								<form method="post" action="">
									<?php
										$sql=mysql_query("SELECT * FROM upload WHERE member_id='$userid'") or die(mysql_error());
										$getpic=mysql_fetch_array($sql);
										echo "<center><img src='image/members/".$getpic['file_name']."' width='130px' height='230px' ></center>";
									?>
								</form>
