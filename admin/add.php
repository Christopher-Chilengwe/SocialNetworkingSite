...
<div class="art-content-layout">
                <div class="art-content-layout-row">
                    <div class="art-layout-cell art-sidebar1" style="height: 561px;">
					<br>
					<br>
					<form method="post">
					<p align="center"><input type="text" name="idnumber" style="width:130px;"></p>
					<br>
					<p align="center"><input type="submit" name="add" value="Add ID Number" style="width:130px;"></p>
					<?php
					require('db.php');
					if (isset($_POST['add'])){
					$idnumber = $_POST['idnumber'];
					mysql_query("INSERT INTO id_number (idnumber)
			VALUES ('$idnumber')")or die(mysql_error());}
