...
<div class="art-nav-outer">
	<ul class="art-hmenu">
		...
		<li>
			<a href="aboutus.php" class="active"><span class="l"></span><span class="r"></span><span class="t">
...
<div class="art-layout-cell art-sidebar1">
    ...
    <div class="art-block-body" style="width: 442px;">
            <div class="art-blockheader">
                <div class="l"></div>
                <div class="r"></div>
                    <h3 class="t">Social Networking Site</h3>
					<br>
					<p style="padding-left: 5px;">
						&nbsp;&nbsp;&nbsp;&nbsp; The Social Networking Site is one way of communicating to every members. Through this site, members can post their comments, ideas and concerns regarding the institution. The faculty and administration can also post their comments of what are the upcoming activities. Members can also upload photos, add friends, and view ones profile. The site is only intended for the members of the institution named CHMSC-talisay including the students, faculty and staff, alumni as well as the Chmsc personnel. </p>
					<br>
					<p style="padding-left: 5px;">
						&nbsp;&nbsp;&nbsp;&nbsp; Social Networking Site(Clique Us) do not have a chat box, members can only post comments and messages.The Clique Us can give an effective and efficient result in communicating to each other.The site can help the members and the staffs of the said institution to reach out with each other.It also helps to build the relationship between the members of the school. It is a one way to share the thoughts and ideas regarding the schools activities.
					</p>
...
jQuery.flashgallery('gallery/gallery.swf', 'gallery/config.json', { width: '450px', height: '380px', background: 'transparent' });
</script>
			<div style="clear: both;"></div>
			</div>
	</div>
