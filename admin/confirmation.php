...
<div class="art-content-layout">
        ...
        <thead >
                <tr>
						<th sort="description" align="center"><span class="style7">Member ID</span></th>
	  ...
	  <?php
				...
				$query = ("SELECT * FROM members WHERE account_status = 0") or die(mysql_error()); 
				...
				echo "<td align='center'><a href='confirm.php?id=".$row['student_id']."'>confirm</a></td>";
