...
<div class="art-content-layout">
        ...
        <thead >
                <tr>
                        ...
                        <th sort="beds" align="center"><span class="style7" >Comments in Post</span></th>
						<th sort="beds" align="center"><span class="style7">Date</span></th>
						<th sort="beds" align="center"><span class="style7">Delete Comment</span></th>
	    ...
	    <?php
				...
				$query = "SELECT postcomments.postcommentid, postcomments.postid, postcomments.memberid,  postcomments.comment, postcomments.date, members.member_id, members.firstname, members.lastname FROM members LEFT JOIN postcomments ON postcomments.memberid=members.member_id "; 
