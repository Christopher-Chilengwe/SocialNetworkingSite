			...
			<div class="art-block-body">
						...
						<div class="art-blockcontent">
							...
							<?php
								...
								?>
							<input type="text" name="froms" id="inputtype" value="<?php  echo $row['member_id']; ?>">
							...
							?>					
							<input type = "text" name = "sendtos" id ="inputtype" value = "<?php echo $rows['member_id'];?>">
							</p>
							<p align="left">Message:
							<p><textarea name="messages"></textarea></p>
							
							<p align="right"><input type="submit" id="inputsubmit" name="sends" value="Send">
							</p>
						</form>
