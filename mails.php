...
<div class="art-nav-outer">
	<ul class="art-hmenu">
		...
		<li>
			<a href="updates.php" class="active"><span class="l"></span><span class="r"></span>
			...
			<div class="art-block-body">
						...
						<div class="cleared"></div>
							...
							<?php
								...
								$receiveda = mysql_numrows($received);
							?>
								<a href="sentmails.php" style="text-decoration:none;">Sent Mails(<?php echo $senta;?>)</a>
								
								<a href="receivesmails.php" style="text-decoration:none;">Received Mails(<?php echo $receiveda;?>)</a>
								<a href="messages.php" style="text-decoration:none;" >Create Mails</a>
