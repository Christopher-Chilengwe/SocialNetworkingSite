		...
		<div class="art-post-inner art-article">
			...
			<div class="art-block-body">
						<div class="art-blockheader">
							<div class="l"></div>
							<div class="r"></div>
							<h3 class="t">Add as School Friend <a href=""><img src="images/del.jpg" style="padding-left:200px;  margin-top: 4px;"></a> </h3>
						</div>
							...
							<?php
								...
								while($row = mysql_fetch_array($post)){
									echo '
										...
										<p align="left">'.$row['firstname']." ".$row['lastname'].'</p>
										<p align="left">Your friend request has been sent, just wait for the confirmation</p>
									';
								}
							?>
