<?php 
	 ...
	 if(isset($_POST['save'])) 
 {
			...
			$sql = mysql_query("UPDATE members SET firstname = '$firstname', lastname = '$lastname', password = '$password', address = '$address',url = '$url',gender = '$gender', contact_no = '$contact', interest = '$interest', WHERE member_id = $id");
...
<div align="center" style="margin-top: 20px;"> 
		...
		<img src="images/edit_friend.png"><a href="edit.php?id=<?php echo $member_id;?>" rel='facebox'> Update Profile </a></strong> &nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="art-post">
		...
		<br>
								<p>&nbsp;&nbsp;Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="text" name="firstname" id="inputtype" value="<?php echo $first; ?>">&nbsp;<input type="text" name="lastname" id="inputtype" value="<?php echo $last; ?>"></p>
								<br>
								<p>&nbsp;&nbsp;Change Password:
